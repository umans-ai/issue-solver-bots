          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-foreground/80">
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 min-w-max py-2 bg-background/95 backdrop-blur-lg border border-border/50 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <Link
                    href="/offers/code"
                    className="flex items-center gap-2 px-4 py-2 hover:bg-muted transition-colors whitespace-nowrap"
                  >
